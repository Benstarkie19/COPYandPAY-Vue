                ...
                <div class="alert alert-danger" role="alert" v-if="error !== null">
                    ...
                    <div class="mb-6 md:my-6">
                        <label for="email"  class="block mb-2  text-sm text-black-600 dark:text-black-400">Email Address</label>
                         ...
                         <div class="col-md-6">
                             <input id="email" type="email"  placeholder="ben@gmail.com" class="form-control rounded px-4 w-full py-1 bg-gray-200  border border-gray-400 mb-6 text-gray-700 placeholder-gray-700 focus:bg-white focus:outline-none" v-model="email" required autofocus autocomplete="off">
                                </div>

                    <div class="mb-6  md:my-6">
                        <label for="password" class="text-sm text-black-600 dark:text-black-400">Password</label>
                        <div class="col-md-6">
                             <input id="password" type="password"  placeholder="12345678" class="form-control rounded px-4 w-full py-1 bg-gray-200  border border-gray-400 mb-6 text-gray-700 placeholder-gray-700 focus:bg-white focus:outline-none" v-model="password" required autocomplete="off">
                            </div>
                            </div>
